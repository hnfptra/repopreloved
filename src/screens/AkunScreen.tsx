...
const menuItems: Array<{ label: string; icon: ReactNode; screen?: number; last?: boolean }> = [
  { label: 'Pesanan Saya', screen: 12, icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="4" y="4" width="16" height="17" rx="2"/><path d="M8 9h8M8 13h8M8 17h5"/></svg> },
  { label: 'Favorit', screen: 13, icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 21s-7-4.5-9.5-9C.7 8.4 2.4 5 6 5c2 0 3.3 1 4 2.2C10.7 6 12 5 14 5c3.6 0 5.3 3.4 3.5 7-2.5 4.5-9.5 9-9.5 9z"/></svg> },
  { label: 'Alamat', screen: 14, icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 21s7-7.5 7-12a7 7 0 10-14 0c0 4.5 7 12 7 12z"/><circle cx="12" cy="9" r="2.3"/></svg> },
  { label: 'Metode Pembayaran', screen: 11, icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="2.5" y="6" width="19" height="13" rx="2"/><path d="M2.5 10h19"/></svg> },
    ...
    <div className="screen-enter flex flex-col flex-1 min-h-0" style={{ background: '#F7F3EC' }}>
      ...
      <div className="flex-1 overflow-y-auto no-scrollbar" style={{ padding: '18px 18px 18px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 13, marginBottom: 18 }}>
          ...
          <div>
            <div style={{ fontWeight: 700, fontSize: 16, marginBottom: 2, fontFamily: "'Plus Jakarta Sans', sans-serif" }}>Halo, Mas Anam!</div>
            <button
              type="button"
          ...
          {menuItems.map((item) => (
            <button
              ...
              style={{
                ...
                padding: '13px 2px',
                border: 'none',
                borderBottom: item.last ? 'none' : '1px solid #DED5C3',
                background: 'transparent',
                color: '#232A22',
                cursor: 'pointer',
                textAlign: 'left',
